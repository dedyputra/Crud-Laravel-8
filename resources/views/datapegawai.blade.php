...
@push('css')
  <!-- Bootstrap CSS -->
  <link href="{{asset('template/https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous"')}}>
...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="card-body">
     ...
     <input class="form-control form-control-navbar" type="search" id="inputPassword6\" name="search" placeholder="Search" aria-label="Search">   
    </form>
      </div>
      <br><br>
